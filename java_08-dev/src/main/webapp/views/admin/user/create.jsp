            ...
            <section class="section dashboard">
                <div class="card">
                    <div class="card-body p-3">
                        ...
                        <form:form method="POST" modelAttribute="user" action="/admin/users/store" enctype="multipart/form-data" class="row needs-validation" id="form-create">
                            <div class="col-sm-6 mb-3">
                                <div class="form-floating mb-1">
                                    <input type="text" class="form-control" name="fullName" id="fullName" required placeholder="Họ và tên" />
                            ...
                            <div class="col-sm-6 mb-3">
                                <div class="form-floating mb-1">
                                    <input type="text" class="form-control" required name="username" id="username" placeholder="Tài khoản" />
                                    <label for="username">Tài khoản</label>
                                </div>
                                <form:errors path="username" cssClass="ms-1 text-danger"/>
                                <!-- <label class="text-note">Tài khoản được dùng đăng nhập hệ thống</label> -->
                            </div>

                            <div class="col-sm-6 mb-3">
                                <div class="form-floating mb-1">
                                    <form:input path="phone" type="text" class="form-control" name="phone" id="phone" placeholder="Điện thoại" />
