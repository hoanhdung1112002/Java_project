                    ...
                    <div class="card">
                        <div class="card-body py-3 px-0 py-sm-5 px-sm-4">
                            ...
                            <form class="container" method="POST" action="/auth/login">
                                ...
                                <div class="d-flex justify-content-between my-4">
                                    <div class="reml">
                                        <label class="form-check-label d-flex align-items-center">
                                            <input type="checkbox" class="form-check-input m-0 me-1" aria-label="Ghi nhớ đăng nhập">
                                            <span class="checkbox-icon"></span>
                                            <span class="form-check-description">Ghi nhớ đăng nhập</span>
                                        </label>
                                    </div>
                                    <div class="remr">
                                        <a style="font-size: 14px;" href="#">Quên mật khẩu?</a>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-0 btn-offset-parent">
