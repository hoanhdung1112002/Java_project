                ...
                <div class="col-12 mx-auto">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form:form method="POST" modelAttribute="post" action="/posts/update/${post.getID()}" enctype="multipart/form-data" class="row h-100">
                                <div class="col-12">
                                    <div class="form-group">
                                        <label for="title">Tiêu đề bài viết</label>
                                        <input type="text" value="${post.getTitle()}" class="form-control" name="title" id="title" placeholder="Nhập tiêu đề">
                                ...
                                <div class="col-12 posts-list h-100 overflow-y-auto scroll-custom scroll-none">
                                    <textarea class="tinymce-editor form-control"  name="content" id="content" cols="30" rows="10">${post.getContent()}</textarea>
                                </div>
